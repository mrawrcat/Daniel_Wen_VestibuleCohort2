...
I believe the code was meant to function as a sort of screensaver
.
What i would fix is to make the position of the boxes more aligned toward the 
center by changing the start of the i and j variables

I would also move the background to the draw function as that would cover up the
